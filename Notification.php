                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Send Notification to the Shared Users</h6>
                        </div>
            ...
            try {
                ...
                foreach ($permissions->getPermissions() as $permission) {
                    ...
                    if (isset($permission->emailAddress)) {
                        ...
                        echo '<td><a href="send_mail.php?email=' . base64_encode($permission->emailAddress) . '" target="_blank">' . htmlspecialchars($permission->emailAddress) . '</a></td>';
                        array_push($emailAddress, $permission->emailAddress);
                    } else {
                ...
                $emailString = implode(',', $emailAddress);
                //echo $emailString;
                // Base64 encode the email list
                $encodedEmailList = base64_encode($emailString);

                
// Using echo to create a styled div tag
echo '</br><div class="row"><div class="col-xl-4 col-md-6 mb-4"></div> <div class="col-xl-4 col-md-6 mb-4"><a href="send_mail.php?emails=' . base64_encode($emailString) . '" target="_blank" class="btn btn-success"> Send Email (All Recipients) </a></div><div class="col-xl-4 col-md-6 mb-4"></div>
                            </div> ';
